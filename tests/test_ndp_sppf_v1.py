"""Regression tests for NDP's fixed formula, graph and diagnostic matching contract."""
...
from tools.experiments.finish_b19_ndp_sppf_v1 import match_objects, package
from tools.experiments.run_b19_ndp_sppf_v1 import execute_preflight
from tools.experiments.verify_b19_ndp_sppf_v1 import branch_checks, structural_checks
...
def test_window_formula():
    """Check independent valid-window reference, input gradients and actual FP32 operator dtypes."""
    branch_checks()
