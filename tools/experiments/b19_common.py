...
MODEL = ROOT / "ultralytics/cfg/models/26/yolo26n-dcs-sppf-v1.yaml"
...
def audit_weights(baseline, candidate, weights, new_prefix=("model.9.refine.", "model.9.fuse.", "model.9.theta")):
